...
%%%%                  T. WEST IMPERIAL COLLEGE LONDON (2024)           %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
R.artRej.meth = 'visual'; % can be 'auto' or 'visual'
artefactRejectData(R)

%% Check Movement Axes are Standardized
correctMovementAxes(R)
