...
subSelET = setdiff(12:23, [15 17 21]);
subSelCONT = setdiff(1:11, [4 7]);
subSelAll = setdiff(1:23, [4 7 15 17 21]);

subSelOPMCont = {[], setdiff(1:5, []), setdiff(1:5, []), setdiff(1:5, [1]), setdiff(1:5, [])};
subSelOPMPat = {[], setdiff(1:4, []), setdiff(1:4, []), setdiff(1:4, [1]), setdiff(1:4, [4])};
