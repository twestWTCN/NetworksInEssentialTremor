...
addpath(genpath(fullfile(gitpath,'fooof_mat'))); % fooof MATLAB wrapper
addpath(genpath(fullfile(gitpath,'Violinplot-Matlab'))); % Violin plot
addpath(genpath(fullfile(gitpath,'scannercast'))); % Violin plot
addpath(genpath(fullfile(gitpath,'MEMES'))); % PSEUDOMRI

% addpath([gitpath '\analyse_OPMEG']);
